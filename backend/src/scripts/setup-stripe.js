...
const PLANS = {
  STARTER: { name: 'Starter', monthlyPrice: 12, yearlyPrice: 99, credits: 100 },
  PRO: { name: 'Pro', monthlyPrice: 34, yearlyPrice: 290, credits: 500 },
  BUSINESS: { name: 'Business', monthlyPrice: 89, yearlyPrice: 790, credits: 2000 },
